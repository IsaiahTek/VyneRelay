...
export class RedisStore {
    ...
    async getSince(topic, sinceId, sinceTimestamp) {
        ...
        if (sinceId) {
            ...
            const records = all.map((r) => JSON.parse(r));
            const idx = records.findIndex((r) => r.id === sinceId);
